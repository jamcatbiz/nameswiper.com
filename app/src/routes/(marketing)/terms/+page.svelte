<div
  class="flex flex-col w-full justify-center text-left container mx-4 mb-10 p-6 shadow-md"
>
  <h1 class="text-3xl font-semibold pt-2">Terms & Conditions</h1>
  <p class="pt-0.5 text-sm font-light">Last updated: July 20, 2025</p>

  <h1 class="text-2xl font-semibold pt-2">General Terms</h1>
  <p class="pt-3">
    By accessing and placing an order with Name Swiper, you confirm that you are
    ...
    email or other type of communication between you and Name Swiper.
  </p>
  <p class="pt-3">
    Under no circumstances shall Name Swiper team be liable for any direct,
    indirect, special, incidental or consequential damages, including, but not
    limited to, loss of data or profit, arising out of the use, or the inability
    to use, the materials on this site, even if Name Swiper team or an
  ...
  <p class="pt-3">
    Name Swiper will not be responsible for any outcome that may occur during
    the course of usage of our resources. We reserve the rights to change prices
    and revise the resources usage policy in any moment. This Terms & Conditions
    was created with <a href="https://termify.io" target="_blank">Termify</a>.
  </p>

  <h1 class="text-2xl font-semibold pt-2">License</h1>
  <p class="pt-3">
    Name Swiper grants you a revocable, non-exclusive, non-transferable, limited
    license to download, install and use the website strictly in accordance with
    the terms of this Agreement.
  </p>
  <p class="pt-3">
    These Terms & Conditions are a contract between you and Name Swiper
    (referred to in these Terms & Conditions as "Name Swiper", "us", "we" or
    "our"), the provider of the Name Swiper website and the services accessible
    from the Name Swiper website (which are collectively referred to in these
    Terms & Conditions as the "Name Swiper Service").
  </p>
  <p class="pt-3">
    You are agreeing to be bound by these Terms & Conditions. If you do not
    agree to these Terms & Conditions, please do not use the Name Swiper
  ...
  <h1 class="text-2xl font-semibold pt-2">Definitions and key terms</h1>
  <p class="pt-3">
  ...
  <ul class="pl-4 pt-1">
    <li>
      Cookie:Â&nbsp;small amount of data generated by a website and saved by
      your web browser. It is used to identify your browser, provide analytics,
    ...
    <li class="pt-1">
      ...
      refers to Name Swiper, that is responsible for your information under this
      Terms & Conditions.
    </li>
    <li class="pt-1">
      Country: where Name Swiper or the owners/founders of Name Swiper are
      based, in this case is
    </li>
    <li class="pt-1">
      Device:Â&nbsp;any internet connected device such as a phone, tablet,
      computer or any other device that can be used to visit Name Swiper and use
      the services.
    </li>
    <li class="pt-1">
      Service: refers to the service provided by Name Swiper as described in the
    ...
    <li class="pt-1">
      Website: Name Swiper's site, which can be accessed via this URL:
      https://nameswiper.com
    </li>
    <li class="pt-1">
      You: a person or entity that is registered with Name Swiper to use the
      Services.
    </li>
  </ul>

  <h1 class="text-2xl font-semibold pt-2">Restrictions</h1>
  <p class="pt-3">You agree not to, and you will not permit others to:</p>
  <ul class="pl-4 pt-1">
    <li>
    ...
    <li class="pt-1">
      ...
      copyright or trademark) of Name Swiper or its affiliates, partners,
      suppliers or the licensors of the website.
    </li>
  </ul>
  <h1 class="text-2xl font-semibold pt-2">Return and Refund Policy</h1>
  <p class="pt-3">
    Thanks for shopping at Name Swiper. We appreciate the fact that you like to
  ...
  <p class="pt-3">
    ...
    to transactions at Name Swiper. We'll be as brief as our attorneys will
    allow. The main thing to remember is that by placing an order or making a
    purchase at Name Swiper, you agree to the terms along with Name
    Swiper'sÂ&nbsp;Privacy Policy.
  </p>
  <p class="pt-3">
  ...
  <h1 class="text-2xl font-semibold pt-2">Your Suggestions</h1>
  <p class="pt-3">
    Any feedback, comments, ideas, improvements or suggestions (collectively,
    "Suggestions") provided by you to Name Swiper with respect to the website
    shall remain the sole and exclusive property of Name Swiper.
  </p>
  <p class="pt-3">
    Name Swiper shall be free to use, copy, modify, publish, or redistribute the
    Suggestions for any purpose and in any way without any credit or any
    compensation to you.
  </p>

  <h1 class="text-2xl font-semibold pt-2">Your Consent</h1>
  <p class="pt-3">
    ...
    it's being used. By using our website, registering an account, or making a
    purchase, you hereby consent to our Terms & Conditions.
  </p>

  <h1 class="text-2xl font-semibold pt-2">Links to Other Websites</h1>
  <p class="pt-3">
    This Terms & Conditions applies only to the Services. The Services may
    contain links to other websites not operated or controlled by Name Swiper.
    We are not responsible for the content, accuracy or opinions expressed in
    such websites, and such websites are not investigated, monitored or checked
    for accuracy or completeness by us. Please remember that when you use a link
    to go from the Services to another website, our Terms & Conditions are no
  ...
  <h1 class="text-2xl font-semibold pt-2">Cookies</h1>
  <p class="pt-3">
    Name Swiper uses "Cookies" to identify the areas of our website that you
    ...
    you visit the website as we would not be able to remember that you had
  ...
  <h1 class="text-2xl font-semibold pt-2">Changes To Our Terms & Conditions</h1>
  <p class="pt-3">
    You acknowledge and agree that Name Swiper may stop (permanently or
    ...
    inform Name Swiper when you stop using the Service. You acknowledge and
    agree that if Name Swiper disables access to your account, you may be
  ...
  <h1 class="text-2xl font-semibold pt-2">Modifications to Our website</h1>
  <p class="pt-3">
    Name Swiper reserves the right to modify, suspend or discontinue,
    temporarily or permanently, the website or any service to which it connects,
    with or without notice and without liability to you.
  </p>

  <h1 class="text-2xl font-semibold pt-2">Updates to Our website</h1>
  <p class="pt-3">
    Name Swiper may from time to time provide enhancements or improvements to
  ...
  <p class="pt-3">
    ...
    website. You agree that Name Swiper has no obligation to (i) provide any
  ...
  <p class="pt-3">
    ...
    integral part of the website, and (ii) subject to the terms and conditions
    of this Agreement.
  </p>

  <h1 class="text-2xl font-semibold pt-2">Third-Party Services</h1>
  <p class="pt-3">
  ...
  <p class="pt-3">
    You acknowledge and agree that Name Swiper shall not be responsible for any
    ...
    aspect thereof. Name Swiper does not assume and shall not have any liability
  ...
  <h1 class="text-2xl font-semibold pt-2">Term and Termination</h1>
  <p class="pt-3">
    This Agreement shall remain in effect until terminated by you or Name
    Swiper.
  </p>
  <p class="pt-3">
    Name Swiper may, in its sole discretion, at any time and for any or no
    reason, suspend or terminate this Agreement with or without prior notice.
  </p>
  <p class="pt-3">
    This Agreement will terminate immediately, without prior notice from Name
    Swiper, in the event that you fail to comply with any provision of this
    Agreement. You may also terminate this Agreement by deleting the website and
  ...
  <p class="pt-3">
    Termination of this Agreement will not limit any of Name Swiper's rights or
  ...
  <h1 class="text-2xl font-semibold pt-2">Copyright Infringement Notice</h1>
  <p class="pt-3">
    If you are a copyright owner or such owner's agent and believe any material
    on our website constitutes an infringement on your copyright, please contact
    us setting forth the following information: (a) a physical or electronic
    signature of the copyright owner or a person authorized to act on his
    behalf; (b) identification of the material that is claimed to be infringing;
    (c) your contact information, including your address, telephone number, and
    an email; (d) a statement by you that you have a good faith belief that use
    of the material is not authorized by the copyright owners; and (e) the a
  ...
  <h1 class="text-2xl font-semibold pt-2">Indemnification</h1>
  <p class="pt-3">
    You agree to indemnify and hold Name Swiper and its parents, subsidiaries,
    ...
    to or arising out of your: (a) use of the website; (b) violation of this
    Agreement or any law or regulation; or (c) violation of any right of a third
    party.
  </p>

  <h1 class="text-2xl font-semibold pt-2">No Warranties</h1>
  <p class="pt-3">
    The website is provided to you "AS IS" and "AS AVAILABLE" and with all
    faults and defects without warranty of any kind. To the maximum extent
    permitted under applicable law, Name Swiper, on its own behalf and on behalf
    ...
    foregoing, Name Swiper provides no warranty or undertaking, and makes no
  ...
  <p class="pt-3">
    Without limiting the foregoing, neither Name Swiper nor any Name Swiper's
    ...
    from or on behalf of Name Swiper are free of viruses, scripts, trojan
  ...
  <h1 class="text-2xl font-semibold pt-2">Limitation of Liability</h1>
  <p class="pt-3">
    Notwithstanding any damages that you might incur, the entire liability of
    Name Swiper and any of its suppliers under any provision of this Agreement
    and your exclusive remedy for all of the foregoing shall be limited to the
    amount actually paid by you for the website.
  </p>
  <p class="pt-3">
    To the maximum extent permitted by applicable law, in no event shall Name
    Swiper or its suppliers be liable for any special, incidental, indirect, or
    ...
    any way related to the use of or inability to use the website, third-party
    software and/or third-party hardware used with the website, or otherwise in
    connection with any provision of this Agreement), even if Name Swiper or any
  ...
  <h1 class="text-2xl font-semibold pt-2">Severability</h1>
  <p class="pt-3">
  ...
  <p class="pt-3">
    ...
    published by Name Swiper on the Services, shall constitute the entire
    agreement between you and Name Swiper concerning the Services. If any
    ...
    further or continuing waiver of such term or any other term, and Name
    Swiper's failure to assert any right or provision under this Agreement shall
    not constitute a waiver of such right or provision. YOU AND Name Swiper
    AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR RELATED TO THE SERVICES
    MUST COMMENCE WITHIN ONE (1) YEAR AFTER THE CAUSE OF ACTION ACCRUES.
    OTHERWISE, SUCH CAUSE OF ACTION IS PERMANENTLY BARRED.
  </p>

  <h1 class="text-2xl font-semibold pt-2">Waiver</h1>
  <p class="pt-3">
  ...
  <p class="pt-3">
    ...
    party, any right or any power under this Agreement shall operate as a waiver
  ...
  <h1 class="text-2xl font-semibold pt-2">Amendments to this Agreement</h1>
  <p class="pt-3">
    Name Swiper reserves the right, at its sole discretion, to modify or replace
  ...
  <p class="pt-3">
    ...
    to the new terms, you are no longer authorized to use Name Swiper.
  </p>

  <h1 class="text-2xl font-semibold pt-2">Entire Agreement</h1>
  <p class="pt-3">
    The Agreement constitutes the entire agreement between you and Name Swiper
    regarding your use of the website and supersedes all prior and
    contemporaneous written or oral agreements between you and Name Swiper.
  </p>
  <p class="pt-3">
    You may be subject to additional terms and conditions that apply when you
    use or purchase other Name Swiper's services, which Name Swiper will provide
    to you at the time of such use or purchase.
  </p>

  <h1 class="text-2xl font-semibold pt-2">Updates to Our Terms</h1>
  <p class="pt-3">
    ...
    Service) before we make changes to these Terms and give you an opportunity
    to review them before they go into effect. Then, if you continue to use the
    Service, you will be bound by the updated Terms. If you do not want to agree
    to these or any updated Terms, you can delete your account.
  </p>

  <h1 class="text-2xl font-semibold pt-2">Intellectual Property</h1>
  <p class="pt-3">
    ...
    Name Swiper, its licensors or other providers of such material and are
    ...
    not be copied, modified, reproduced, downloaded or distributed in any way,
    in whole or in part, without the express prior written permission of Name
    Swiper, unless and except as is expressly provided in these Terms &
    Conditions. Any unauthorized use of the material is prohibited.
  </p>

  <h1 class="text-2xl font-semibold pt-2">Agreement to Arbitrate</h1>
  <p class="pt-3">
    ...
    ENFORCEMENT OR VALIDITY OF YOUR OR Name Swiper's INTELLECTUAL PROPERTY
    RIGHTS. The term "disputeâ€ means any dispute, action, or other controversy
    between you and Name Swiper concerning the Services or this agreement,
    whether in contract, warranty, tort, statute, regulation, ordinance, or any
    other legal or equitable basis. "Disputeâ€ will be given the broadest
    possible meaning allowable under law.
  </p>

  <h1 class="text-2xl font-semibold pt-2">Notice of Dispute</h1>
  <p class="pt-3">
    In the event of a dispute, you or Name Swiper must give the other a Notice
    of Dispute, which is a written statement that sets forth the name, address,
    ...
    email to:Â&nbsp;. Name Swiper will send any Notice of Dispute to you by mail
    to your address if we have it, or otherwise to your email address. You and
    Name Swiper will attempt to resolve any dispute through informal negotiation
    within sixty (60) days from the date the Notice of Dispute is sent. After
    sixty (60) days, you or Name Swiper may commence arbitration.
  </p>

  <h1 class="text-2xl font-semibold pt-2">Binding Arbitration</h1>
  <p class="pt-3">
    If you and Name Swiper don't resolve any dispute by informal negotiation,
  ...
  <h1 class="text-2xl font-semibold pt-2">Submissions and Privacy</h1>
  <p class="pt-3">
    ...
    become the sole property of Name Swiper without any compensation or credit
    to you whatsoever. Name Swiper and its affiliates shall have no obligations
    with respect to such submissions or posts and may use the ideas contained in
  ...
  <h1 class="text-2xl font-semibold pt-2">Promotions</h1>
  <p class="pt-3">
    Name Swiper may, from time to time, include contests, promotions,
    sweepstakes, or other activities ("Promotionsâ€) that require you to submit
    material or information concerning yourself. Please note that all Promotions
    ...
    are responsible to read all Promotions rules to determine whether or not you
    are eligible to participate. If you enter any Promotion, you agree to abide
    by and to comply with all Promotions Rules.
  </p>
  <p class="pt-3">
    Additional terms and conditions may apply to purchases of goods or services
    on or through the Services, which terms and conditions are made a part of
    this Agreement by this reference.
  </p>

  <h1 class="text-2xl font-semibold pt-2">Typographical Errors</h1>
  <p class="pt-3">
    ...
    card charged. If your credit card has already been charged for the purchase
  ...
  <h1 class="text-2xl font-semibold pt-2">Miscellaneous</h1>
  <p class="pt-3">
    ...
    writing and signed by an authorized representative of Name Swiper. Name
    Swiper will be entitled to injunctive or other equitable relief (without the
    obligations of posting any bond or surety) in the event of any breach or
    anticipatory breach by you. Name Swiper operates and controls the Name
    Swiper Service from its offices in . The Service is not intended for
    distribution to or use by any person or entity in any jurisdiction or
    country where such distribution or use would be contrary to law or
    regulation. Accordingly, those persons who choose to access the Name Swiper
    ...
    are applicable. These Terms & Conditions (which include and incorporate the
    Name Swiper Privacy Policy) contains the entire understanding, and
    supersedes all prior understandings, between you and Name Swiper concerning
  ...
  <h1 class="text-2xl font-semibold pt-2">Disclaimer</h1>
  <p class="pt-3">
    Name Swiper is not responsible for any content, code or any other
    imprecision.
  </p>
  <p class="pt-3">Name Swiper does not provide warranties or guarantees.</p>
  <p class="pt-3">
    In no event shall Name Swiper be liable for any special, direct, indirect,
  ...
  <p class="pt-3">
    The Name Swiper Service and its contents are provided "as is" and "as
    available" without any warranty or representations of any kind, whether
    express or implied. Name Swiper is a distributor and not a publisher of the
    content supplied by third parties; as such, Name Swiper exercises no
    ...
    service or merchandise provided through or accessible via the Name Swiper
    Service. Without limiting the foregoing, Name Swiper specifically disclaims
    all warranties and representations in any content transmitted on or in
    connection with the Name Swiper Service or on sites that may appear as links
    on the Name Swiper Service, or in the products provided as a part of, or
    otherwise in connection with, the Name Swiper Service, including without
    limitation any warranties of merchantability, fitness for a particular
    purpose or non-infringement of third party rights. No oral advice or written
    information given by Name Swiper or any of its affiliates, employees,
    ...
    limiting the foregoing, Name Swiper does not warrant that the Name Swiper
    Service will be uninterrupted, uncorrupted, timely, or error-free.
  </p>

  <h1 class="text-2xl font-semibold pt-2">Contact Us</h1>
  <p class="pt-3">Don't hesitate to contact us if you have any questions.</p>
  <ul class="pl-4 pt-1">
    <li>Via this Link: https://nameswiper.com/contact_us</li>
  </ul>

  <h1 class="text-2xl font-semibold pt-2">Terms & Conditions</h1>
  <p class="pt-3">Updated at 2025-07-20</p>
