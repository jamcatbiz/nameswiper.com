<div class="flex flex-col w-full justify-center text-left container mx-4 mb-10 p-6 shadow-md">
...
<p class="pt-2">
  ...
  this Privacy Policy. This Privacy Policy has been created with the help of the <a
    href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/"
    target="_blank">Free Privacy Policy Generator</a
  >.
</p>
<h2 class="pt-3 text-xl font-semibold">Interpretation and Definitions</h2>
<h3 class="pt-1 text-lg font-medium">Interpretation</h3>
<p class="pt-0.5">
  The words of which the initial letter is capitalized have meanings defined
  under the following conditions. The following definitions shall have the same
  meaning regardless of whether they appear in singular or in plural.
</p>
<h3 class="pt-1 text-lg font-medium">Definitions</h3>
<p class="pt-0.5">For the purposes of this Privacy Policy:</p>
<ul class="pl-4 pt-1">
  <li>
    <p>
  ...
  <li class="pt-1">
    <p>
      ...
      &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Name Swiper.
    </p>
  </li>
  <li class="pt-1">
    <p>
  ...
  <li class="pt-1">
    <p>
      <strong>Website</strong> refers to Name Swiper, accessible from
      <a
        href="https://nameswiper.com"
        rel="external nofollow noopener"
        target="_blank">https://nameswiper.com</a
      >
    </p>
  </li>
  <li class="pt-1">
    <p>
      ...
      the company, or other legal entity on behalf of which such individual is accessing
      or using the Service, as applicable.
    </p>
  </li>
</ul>
<h2 class="pt-3 text-xl font-semibold">Collecting and Using Your Personal Data</h2>
<h3 class="pt-1 text-lg font-medium">Types of Data Collected</h3>
<h4 class="pt-0.5 font-medium">Personal Data</h4>
<p class="pt-2">  While using Our Service, We may ask You to provide Us with certain personally
...
<h4 class="pt-0.5 font-medium">Usage Data</h4>
<p class="pt-2">Usage Data is collected automatically when using the Service.</p>
<p class="pt-2">
...
<p class="pt-2">  When You access the Service by or through a mobile device, We may collect
  certain information automatically, including, but not limited to, the type of
  mobile device You use, Your mobile device unique ID, the IP address of Your
  mobile device, Your mobile operating system, the type of mobile Internet
  browser You use, unique device identifiers and other diagnostic data.
</p>
<p class="pt-2">  We may also collect information that Your browser sends whenever You visit our
  Service or when You access the Service by or through a mobile device.
</p>
<h4 class="pt-0.5 font-medium">Tracking Technologies and Cookies</h4>
<p class="pt-2">  We use Cookies and similar tracking technologies to track the activity on Our
...
<ul class="pl-4 pt-1">
  ...
  <li class="pt-1">
    ...
    clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example,
...
<p class="pt-2">  Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies.
  ...
  browser. Learn more about cookies on the <a
    ...
    target="_blank">Free Privacy Policy website</a
  > article.
</p>
<p class="pt-2">  We use both Session and Persistent Cookies for the purposes set out below:
</p>
<ul class="pl-4 pt-1">
  <li>
...
<p class="pt-2">  For more information about the cookies we use and your choices regarding
  cookies, please visit our Cookies Policy or the Cookies section of our Privacy
  Policy.
</p>
<h3 class="pt-1 text-lg font-medium">Use of Your Personal Data</h3>
<p class="pt-2">The Company may use Personal Data for the following purposes:</p>
<ul class="pl-4 pt-1">
  <li>
    <p>
...
<p class="pt-2">We may share Your personal information in the following situations:</p>
<ul class="pl-4 pt-1">
  <li>
...
<h3 class="pt-1 text-lg font-medium">Retention of Your Personal Data</h3>
<p class="pt-2">  The Company will retain Your Personal Data only for as long as is necessary
  for the purposes set out in this Privacy Policy. We will retain and use Your
  Personal Data to the extent necessary to comply with our legal obligations
  (for example, if we are required to retain your data to comply with applicable
  laws), resolve disputes, and enforce our legal agreements and policies.
</p>
<p class="pt-2">  The Company will also retain Usage Data for internal analysis purposes. Usage
  Data is generally retained for a shorter period of time, except when this data
  is used to strengthen the security or to improve the functionality of Our
  Service, or We are legally obligated to retain this data for longer time
  periods.
</p>
<h3 class="pt-1 text-lg font-medium">Transfer of Your Personal Data</h3>
<p class="pt-2">  Your information, including Personal Data, is processed at the Company's
...
<p class="pt-2">  Your consent to this Privacy Policy followed by Your submission of such
  information represents Your agreement to that transfer.
</p>
<p class="pt-2">  The Company will take all steps reasonably necessary to ensure that Your data
  is treated securely and in accordance with this Privacy Policy and no transfer
  of Your Personal Data will take place to an organization or a country unless
  there are adequate controls in place including the security of Your data and
  other personal information.
</p>
<h3 class="pt-1 text-lg font-medium">Delete Your Personal Data</h3>
<p class="pt-2">  You have the right to delete or request that We assist in deleting the
  Personal Data that We have collected about You.
</p>
<p class="pt-2">  Our Service may give You the ability to delete certain information about You
  from within the Service.
</p>
<p class="pt-2">  You may update, amend, or delete Your information at any time by signing in to
...
<p class="pt-2">  Please note, however, that We may need to retain certain information when we
  have a legal obligation or lawful basis to do so.
</p>
<h3 class="pt-1 text-lg font-medium">Disclosure of Your Personal Data</h3>
<h4 class="pt-0.5 font-medium">Business Transactions</h4>
<p class="pt-2">  If the Company is involved in a merger, acquisition or asset sale, Your
  Personal Data may be transferred. We will provide notice before Your Personal
  Data is transferred and becomes subject to a different Privacy Policy.
</p>
<h4 class="pt-0.5 font-medium">Law enforcement</h4>
<p class="pt-2">  Under certain circumstances, the Company may be required to disclose Your
  Personal Data if required to do so by law or in response to valid requests by
  public authorities (e.g. a court or a government agency).
</p>
<h4 class="pt-0.5 font-medium">Other legal requirements</h4>
<p class="pt-2">  The Company may disclose Your Personal Data in the good faith belief that such
  action is necessary to:
</p>
<ul class="pl-4 pt-1">
  <li>Comply with a legal obligation</li>
  <li class="pt-1">Protect and defend the rights or property of the Company</li>
  <li class="pt-1">
    Prevent or investigate possible wrongdoing in connection with the Service
  </li>
  <li class="pt-1">Protect the personal safety of Users of the Service or the public</li>
  <li class="pt-1">Protect against legal liability</li>
</ul>
<h3 class="pt-1 text-lg font-medium">Security of Your Personal Data</h3>
<p class="pt-2">  The security of Your Personal Data is important to Us, but remember that no
  method of transmission over the Internet, or method of electronic storage is
  100% secure. While We strive to use commercially acceptable means to protect
  Your Personal Data, We cannot guarantee its absolute security.
</p>
<h2 class="pt-3 text-xl font-semibold">Children's Privacy</h2>
<p class="pt-2">  Our Service does not address anyone under the age of 13. We do not knowingly
...
<p class="pt-2">  If We need to rely on consent as a legal basis for processing Your information
  and Your country requires consent from a parent, We may require Your parent's
  consent before We collect and use that information.
</p>
<h2 class="pt-3 text-xl font-semibold">Links to Other Websites</h2>
<p class="pt-2">  Our Service may contain links to other websites that are not operated by Us.
  If You click on a third party link, You will be directed to that third party's
  site. We strongly advise You to review the Privacy Policy of every site You
  visit.
</p>
<p class="pt-2">  We have no control over and assume no responsibility for the content, privacy
  policies or practices of any third party sites or services.
</p>
<h2 class="pt-3 text-xl font-semibold">Changes to this Privacy Policy</h2>
<p class="pt-2">  We may update Our Privacy Policy from time to time. We will notify You of any
  changes by posting the new Privacy Policy on this page.
</p>
<p class="pt-2">  We will let You know via email and/or a prominent notice on Our Service, prior
  to the change becoming effective and update the &quot;Last updated&quot; date
  at the top of this Privacy Policy.
</p>
<p class="pt-2">  You are advised to review this Privacy Policy periodically for any changes.
  Changes to this Privacy Policy are effective when they are posted on this
  page.
</p>
<h2 class="pt-3 text-xl font-semibold">Contact Us</h2>
<p class="pt-2">If you have any questions about this Privacy Policy, You can contact us:</p>
<ul class="pl-4 pt-1">
  <li>
    By visiting this page on our website: <a
      href="https://nameswiper.com/contact_us"
      rel="external nofollow noopener"
      target="_blank">https://nameswiper.com/contact_us</a
    >
  </li>
</ul>
</div>