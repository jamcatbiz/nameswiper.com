...
<div class="py-8 lg:py-12 px-6 max-w-lg mx-auto">
  ...
  >
    <div class="text-center leading-relaxed font-bold text-purple-300">
      {blogInfo.name}
    </div>
  ...
  <div class="text-lg text-center">A blog about names.</div>

  {#each sortedBlogPosts as post}
    <a href={post.link}>
      <div class="card my-6 bg-white shadow-xl flex-row overflow-hidden">
        <div class="flex-none w-6 md:w-32 bg-blue-300"></div>
        <div class="py-6 px-6">
